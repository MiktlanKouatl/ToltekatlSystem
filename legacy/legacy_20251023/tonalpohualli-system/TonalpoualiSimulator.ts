import { ToltekatlEngine, IToltecCoordinate } from './ToltekatlEngine';
import { YEAR_BEARERS, TONALES, YEAR_BEARER_START_TIMES } from './ToltekatlSystem';
...
function runSimulation() {
    ...
    const initialCoordinate: IToltecCoordinate = {
        tonal: { numeral: 1, name: 'Sipaktli' },
        yearBearer: { numeral: 1, name: 'Tochtli' },
    };

    const engine = new ToltekatlEngine(initialCoordinate);
